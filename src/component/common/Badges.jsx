...
export default function Badges({ title = "Air Quality", value = "256" }) {
  return (
    <>
      <div className="inline-flex flex-col  gap-2 rounded-2xl w-full      bg-white shadow-2xl px-6 py-2 text-md font-medium text-gray-400 inset-ring inset-ring-gray-400/20">
